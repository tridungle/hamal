...
import * as animationData from "../jsons/pharmacy.json";
...
export default class SelectedAppAirports extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: undefined
  ...
  componentDidMount() {
    fetch(
      ...
      },${this.props.selectedAppInfo.longitude}/pharmacy`
    )
